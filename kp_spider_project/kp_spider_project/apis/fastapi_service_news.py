...
async def get_random_articles_in_html(
    ...
    html_content = """
        ...
        <head>
            <meta charset="utf-8"/>
            <title>РќРѕРІРѕСЃС‚Рё РѕРЅР»Р°Р№РЅ</title>
            <style>
                body {
        ...
        <body>
            <h1>РЎРІРѕРґРєР° РЅРѕРІРѕСЃС‚РµР№</h1>
        """
    for article in articles:
        html_content += f"""
            <div class="article">
                ...
                <div class="datetime"><b>Р”Р°С‚Р° РїСѓР±Р»РёРєР°С†РёРё:</b> {article.publication_datetime}</div>
                <div class="keywords"><b>РљР»СЋС‡РµРІС‹Рµ СЃР»РѕРІР°:</b> {", ".join(article.keywords)}</div>
                <div class="authors"><b>РђРІС‚РѕСЂС‹:</b> {", ".join(article.authors)}</div>
                <div class="source_url"><b>РЎСЃС‹Р»РєР° РЅР° РёСЃС‚РѕС‡РЅРёРє:</b> 
        ...
        if article.header_photo_base64:
            html_content += f"""
                ...
                <div class="source_url"><a href="{article.header_photo_url}">РЎСЃС‹Р»РєР° РЅР° С„РѕС‚Рѕ</a></div>
                """
        html_content += "</div>"
